...
extern "C" {
        ...
        static const int sign_error_ttl = 8;//8秒后退出应用
        JavaVM  *gJavaVM;
    ...
    //        mIntent.putExtra("sign_error_ttl",sign_error_ttl);
...
//            env->CallBooleanMethod(jobj_Handler,jmd_postDelayed,jobj_SignExitTask,(long long)(sign_error_ttl * 1000+500));
